...
func mix (_ point0: SolidBrushCurvePoint, _ point1: SolidBrushCurvePoint, t blend: Float) -> SolidBrushCurvePoint {
    
    SolidBrushCurvePoint(
        position: mix(point0.position, point1.position, t: blend),
